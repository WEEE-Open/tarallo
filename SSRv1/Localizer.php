...
class Localizer {
	...
	const features = [
		...
		'notes' => 'Notes',
		'agp-sockets-n' => 'Sockets: AGP',
		'arrival-batch' => 'Arrival batch',
		'capacity-decibyte' => 'Capacity ("decimal" bytes)',
		'cib' => 'CIB',
		'core-n' => 'Cores',
		'cpu-socket' => 'Socket (CPU)',
		'dvi-ports-n' => 'Ports: DVI',
		'ethernet-ports-1000m-n' => 'Ports: Ethernet (gigabit)',
		'ethernet-ports-100m-n' => 'Ports: Ethernet (100M)',
		'ethernet-ports-10base2-bnc-n' => 'Ports: Ethernet (10BASE2 BNC)',
		'ethernet-ports-10m-n' => 'Ports: Ethernet (10M)',
		'hdd-odd-form-factor' => 'Form factor (HDD/ODD)',
		'ide-ports-n' => 'Ports: IDE/ATA',
		'odd-type' => 'ODD capabilities',
		'pcie-power-pin-n' => 'PCIe power pins',
		'pcie-sockets-n' => 'Sockets: PCIe',
		'pci-sockets-n' => 'Sockets: PCI',
		'power-connector' => 'Power connector',
		'power-idle-watt' => 'Power consumption (idle)',
		'power-rated-watt' => 'Power (rated)',
		'ps2-ports-n' => 'Ports: PS/2',
		'psu-ampere' => 'Output current',
		'psu-connector-motherboard' => 'Power connector (motherboard)',
		'psu-volt' => 'Output voltage',
		'ram-type' => 'RAM type',
		'sata-ports-n' => 'Ports: SATA',
		'software' => 'Software',
		'usb-ports-n' => 'Ports: USB',
		'vga-ports-n' => 'Ports: VGA',
		'os-license-code' => 'OS license code',
		'os-license-version' => 'OS license version',
		'power-idle-pfc' => 'PFC (idle)',
		'firewire-ports-n' => 'Ports: Firewire',
		'mini-firewire-ports-n' => 'Ports: Mini Firewire',
		'serial-ports-n' => 'Ports: Serial (DE-9)',
		'parallel-ports-n' => 'Ports: Parallel',
		'ram-form-factor' => 'Form factor (RAM)',
		'weight-gram' => 'Weight',
		'spin-rate-rpm' => 'Rotation speed',
		'dms-59-ports-n' => 'Ports: DMS-59',
		'check' => 'Needs to be checked',
		'ram-ecc' => 'ECC',
		'other-code' => 'Other code(s)',
		'hdmi-ports-n' => 'Ports: HDMI',
		'scsi-sca2-ports-n' => 'Ports: SCSI SCA2 (80 pin)',
		'scsi-db68-ports-n' => 'Ports: SCSI DB68 (68 pin)',
		'mini-ide-ports-n' => 'Ports: Mini IDE',
		'data-erased' => 'Erased',
		'surface-scan' => 'Surface scan',
		'smart-data' => 'S.M.A.R.T. data checked',
		'wireless-receiver' => 'Wireless receiver',
		'rj11-ports-n' => 'Ports: RJ11 (modem)',
		'ethernet-ports-10base5-aui-n' => 'Ports: Ethernet (10BASE5 AUI)',
		'midi-ports-n' => 'Ports: MIDI',
		'mini-jack-ports-n' => 'Ports: Mini jack',
		'rca-mono-ports-n' => 'Ports: RCA Mono',
		'tv-out-ports-n' => 'Ports: TV-out',
		's-video-ports-n' => 'Ports: S-Video',
		's-video-7pin-ports-n' => 'Ports: S-Video (7 pin)',
		'composite-video-ports-n' => 'Ports: Composite video',
		'serial-db25-ports-n' => 'Ports: DB-25',
		'isa-sockets-n' => 'Sockets: ISA',
		'mini-pcie-sockets-n' => 'Sockets: Mini PCIe',
		'mini-pci-sockets-n' => 'Sockets: Mini PCI',
		...
		'displayport-ports-n' => 'Ports: DisplayPort',
		'pci-low-profile' => 'PCI low profile',
		'psu-connector-cpu' => 'Power connector (CPU)',
		'jae-ports-n' => 'Ports: JAE (50 pin laptop ODD)',
		'game-ports-n' => 'Ports: Game port',
	];
	const featuresEnum = [
		...
		'cpu-socket/socket478' => '478 (desktop',
		'cpu-socket/socket479a' => '479 (mobile',
		'cpu-socket/socket479c' => '479 (mobile',
		'cpu-socket/socket479m' => '479 (mobile',
		...
		'hdd-odd-form-factor/2.5' => '2.5 in.',
		'hdd-odd-form-factor/2.5-15mm' => '2.5 in. (15 mm thick',
		...
		'hdd-odd-form-factor/laptop-odd-slim' => 'Laptop ODD (slim',
		'odd-type/cd-r' => 'CD-R',
		...
		'psu-connector-cpu/6pin-hp' => '6 pin (HP proprietary)',
