...
class FeaturePrinter {
	...
	const featuresEnum = [
		'type' => ['location' => 'Location', 'case' => 'Case', 'motherboard' => 'Motherboard', 'cpu' => 'CPU', 'graphics-card' => 'Graphics card', 'ram' => 'RAM', 'hdd' => 'HDD', 'ssd' => 'SSD', 'odd' => 'ODD', 'psu' => 'PSU', 'audio-card' => 'Audio card', 'ethernet-card' => 'Ethernet card', 'monitor' => 'Monitor', 'mouse' => 'Mouse', 'keyboard' => 'Keyboard', 'network-switch' => 'Network switch', 'network-hub' => 'Network hub', 'modem-router' => 'Modem/router', 'fdd' => 'FDD', 'ports-bracket' => 'Bracket with ports', 'other-card' => 'Other internal card', 'fan-controller' => 'Fan controller (rheobus)', 'modem-card' => 'Modem card', 'scsi-card' => 'SCSI card', 'wifi-card' => 'WiFi card', 'bluetooth-card' => 'Bluetooth card', 'external-psu' => 'External PSU', 'zip-drive' => 'ZIP drive', 'printer' => 'Printer', 'scanner' => 'Scanner', 'inventoried-object' => 'Other (with invetory sticker)', 'adapter' => 'Adapter', 'usbhub' => 'USB hub', 'tv-card' => 'TV tuner card'],
		...
		'hdd-odd-form-factor' => ['5.25' => '5.25 in.', '3.5' => '3.5 in.', '2.5-15mm' => '2.5 in. (15 mm uncommon)', '2.5-9.5mm' => '2.5 in. (9.5 mm)', '2.5-7mm' => '2.5 in. (7 mm)', '1.8-9.5mm' => '1.8 in. (9.5 mm)', '1.8-8mm' => '1.8 in. (8 mm)', '1.8-5mm' => '1.8 in. (5 mm)', 'm2' => 'M2', 'm2.2' => 'M2.2', 'laptop-odd-7mm' => 'SFF-8553 (7 mm)', 'laptop-odd-8.5mm' => 'SFF-8553 (8.5 mm)', 'laptop-odd-9.5mm' => 'SFF-8552 (9.5 mm standard cut corner)', 'laptop-odd-12.7mm' => 'SFF-8552 (12.7 mm cut corner)'],
