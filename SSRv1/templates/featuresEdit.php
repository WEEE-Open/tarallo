		...
		<ul>
			<?php foreach($group as $ultra): /** @var $ultra \WEEEOpen\Tarallo\SSRv1\UltraFeature */ ?>
				<li class="feature-edit-<?= $ultra->name ?> feature-edit">
					...
					<?php switch($ultra->type): case WEEEOpen\Tarallo\Server\BaseFeature::ENUM: ?>
					...
					<?php break; default: case WEEEOpen\Tarallo\Server\BaseFeature::STRING: ?>
					...
					<?php break; case WEEEOpen\Tarallo\Server\BaseFeature::INTEGER: ?>
					...
					<?php break; case WEEEOpen\Tarallo\Server\BaseFeature::DOUBLE: ?>
