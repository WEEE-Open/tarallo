				...
				?><li class="feature-edit-<?= $ultra->name ?> feature-edit pr-4">
					...
					<?php switch ($ultra->type) :
						...
						case WEEEOpen\Tarallo\BaseFeature::STRING:
							?>
						<input class="value" type="text" data-internal-name="<?= $ultra->name ?>" value="<?= $this->e($ultra->value) ?>" data-initial-value="<?= $ultra->value ?>" id="feature-el-<?= $ultra->name ?>"></input>
							<?php
									   break; case WEEEOpen\Tarallo\BaseFeature::INTEGER:
								?>
						<input class="value" type="number" step="1" data-internal-name="<?= $ultra->name ?>" value="<?= $ultra->value ?>" data-initial-value="<?= $ultra->value ?>" id="feature-el-<?= $ultra->name ?>"></input>
								<?php
												  break; case WEEEOpen\Tarallo\BaseFeature::DOUBLE:
											?>
						<input class="value" type="number" step="0.01" data-internal-name="<?= $ultra->name ?>" value="<?= $ultra->value ?>" data-initial-value="<?= $ultra->value ?>" id="feature-el-<?= $ultra->name ?>"></input>
					<?php endswitch; ?>
