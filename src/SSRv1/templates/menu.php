...
<nav class="navbar navbar-expand-md navbar-light bg-secondary" id="main">
	...
	<div class="collapse navbar-collapse" id="menu">
		...
		<form class="form-inline my-2 my-md-0 justify-content-end" action="/search" method="post">
			<input required class="form-control basicAutoComplete mx-0 mr-sm-2" type="search" aria-label="Search" name="search" autocomplete="off" data-url="/v2/autosuggest/code">
